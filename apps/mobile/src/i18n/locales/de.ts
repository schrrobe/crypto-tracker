const de = {
  ...
  dashboard: {
    ...
    range30d: '30T',
    range1y: '1J',
    historyExcluded: '{n} Asset(s) nicht enthalten – Verlauf zeigt die größten Positionen.',
    ...
    historyEmpty: 'Noch kein Verlauf für deine Assets verfügbar.',
  ...
  pnl: {
    ...
    coverage: 'Erfasst {covered} von {total} Beständen mit Transaktionshistorie. {value} nicht enthalten.',
    error: 'Gewinn/Verlust konnte nicht geladen werden.',
  },
  paywall: {
    ...
    maybeLater: 'Später',
    unavailable: 'Upgrades sind derzeit nicht verfügbar. Bitte versuche es später erneut.',
    planFree: 'Free',
    planPro: 'Pro',
    context: {
      tax: 'Erstelle einen Steuerreport für Deutschland & Österreich — mit Pro.',
      pnl: 'Sieh deinen laufenden Gewinn/Verlust — mit Pro.',
      autoSync: 'Halte deine Bestände automatisch aktuell — mit Pro.',
      history1y: 'Sieh ein ganzes Jahr Wertverlauf — mit Pro.',
      unlimitedPortfolios: 'Lege mehr Portfolios an — mit Pro unbegrenzt.',
      unlimitedSources: 'Verbinde mehr Quellen — mit Pro unbegrenzt.',
    },
    feature: {
  ...
  referral: {
    settingsEntry: 'Empfehlungsprogramm',
    title: 'Einladen & Pro verdienen',
    rewardHeadline: 'Lade Freunde ein – ihr bekommt beide {days} Tage Pro gratis',
    rewardSub: 'Dein Freund erhält {days} Tage Pro bei der Registrierung, du {days} Tage, sobald er Pro wird.',
    linkLabel: 'Dein Empfehlungslink',
    share: 'Link teilen',
    shareText: 'Verwalte dein Krypto-Portfolio mit dieser App – mit meinem Code bekommst du Pro gratis:',
    copied: 'Link kopiert',
    earnedProDays: 'Verdiente Pro-Tage',
    proConversions: 'Pro-Konversionen',
    invited: 'Eingeladene Accounts',
    invitedEmpty: 'Noch keine Einladungen.',
  },
  update: {
  ...
  sources: {
    ...
    countLimit: '{used} von {limit} kostenlosen Quellen genutzt',
  ...
  settings: {
    ...
    autoSyncHelper: 'Hält deine Bestände automatisch aktuell, etwa stündlich (Pro).',
    autoSyncFailed: 'Die Einstellung konnte nicht gespeichert werden',
