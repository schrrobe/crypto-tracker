const de = {
  ...
  referral: {
    ...
    title: 'Einladen & verdienen',
    linkLabel: 'Dein Empfehlungslink',
    share: 'Link teilen',
    shareText: 'Verwalte dein Krypto-Portfolio mit dieser App:',
    copied: 'Link kopiert',
    earningsOwed: 'Offene Einnahmen',
    earningsPaid: 'Ausgezahlt',
    invited: 'Eingeladene Accounts',
    invitedEmpty: 'Noch keine Einladungen.',
    bankTitle: 'Auszahlungskonto',
    bankSaved: 'Hinterlegtes Konto',
    holder: 'Kontoinhaber',
    iban: 'IBAN',
    bic: 'BIC',
    save: 'Speichern',
