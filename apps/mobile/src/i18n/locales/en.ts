...
const en: MessageSchema = {
  ...
  dashboard: {
    ...
    range30d: '30d',
    range1y: '1Y',
    historyExcluded: '{n} asset(s) not included — history shows your largest holdings.',
    historyNote: 'Based on current holdings at historical prices, not on past buys/sells.',
    historyError: 'Could not load history.',
    historyEmpty: 'No history available for your assets yet.',
  ...
  pnl: {
    ...
    coverage: 'Covers {covered} of {total} holdings with transaction history. {value} not included.',
    error: 'Profit/loss could not be loaded.',
  },
  paywall: {
    ...
    unavailable: 'Upgrades are not available right now. Please try again later.',
    planFree: 'Free',
    planPro: 'Pro',
    context: {
      tax: 'Generate a tax report for Germany & Austria — upgrade to Pro.',
      pnl: 'See your running profit/loss — upgrade to Pro.',
      autoSync: 'Keep your balances up to date automatically — upgrade to Pro.',
      history1y: 'See a full year of value history — upgrade to Pro.',
      unlimitedPortfolios: 'Add more portfolios — upgrade to Pro for unlimited.',
      unlimitedSources: 'Connect more sources — upgrade to Pro for unlimited.',
    },
    feature: {
  ...
  referral: {
    ...
    rewardHeadline: 'Invite friends – you both get {days} days of Pro free',
    rewardSub: 'Your friend gets {days} days of Pro on sign-up; you get {days} days once they go Pro.',
    linkLabel: 'Your referral link',
    share: 'Share link',
    shareText: 'Track your crypto portfolio with this app – use my code to get Pro free:',
    copied: 'Link copied',
    earnedProDays: 'Pro days earned',
  ...
  sources: {
    ...
    countLimit: '{used} of {limit} free sources used',
  ...
  settings: {
    ...
    autoSyncHelper: 'Keeps your balances up to date automatically, about every hour (Pro).',
    autoSyncFailed: 'The setting could not be saved',
  ...
  surveys: {
    ...
    identifiedNote: 'Your answers are linked to your account.',
    optionalHint: 'Answer as many questions as you like.',
    alreadySubmitted: 'You have already answered this survey.',
