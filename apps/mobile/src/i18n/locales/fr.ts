...
const fr: MessageSchema = {
  ...
  dashboard: {
    ...
    range30d: '30j',
    range1y: '1A',
    historyExcluded: "{n} actif(s) non inclus — l'historique montre vos plus grandes positions.",
    ...
    historyEmpty: 'Aucun historique disponible pour vos actifs.',
  ...
  pnl: {
    ...
    coverage: 'Couvre {covered} sur {total} avoirs avec historique de transactions. {value} non inclus.',
    error: "Le gain/perte n'a pas pu être chargé.",
  },
  paywall: {
    ...
    unavailable: 'Les mises à niveau ne sont pas disponibles pour le moment. Réessayez plus tard.',
    planFree: 'Free',
    planPro: 'Pro',
    context: {
      tax: "Générez un rapport fiscal pour l'Allemagne et l'Autriche — avec Pro.",
      pnl: 'Voyez votre gain/perte en cours — avec Pro.',
      autoSync: 'Gardez vos soldes à jour automatiquement — avec Pro.',
      history1y: "Voyez une année entière d'historique de valeur — avec Pro.",
      unlimitedPortfolios: 'Ajoutez plus de portefeuilles — illimité avec Pro.',
      unlimitedSources: 'Connectez plus de sources — illimité avec Pro.',
    },
    feature: {
  ...
  referral: {
    ...
    title: 'Invitez et gagnez du Pro',
    rewardHeadline: 'Invitez vos amis – vous obtenez tous les deux {days} jours de Pro gratuits',
    rewardSub: 'Votre ami reçoit {days} jours de Pro à l’inscription ; vous recevez {days} jours dès qu’il passe à Pro.',
    linkLabel: 'Votre lien de parrainage',
    share: 'Partager le lien',
    shareText: 'Suivez votre portefeuille crypto avec cette application – utilisez mon code pour obtenir Pro gratuitement :',
    copied: 'Lien copié',
    earnedProDays: 'Jours Pro gagnés',
    proConversions: 'Conversions Pro',
  ...
  sources: {
    ...
    countLimit: '{used} sur {limit} sources gratuites utilisées',
  ...
  settings: {
    ...
    autoSyncHelper: 'Maintient vos soldes à jour automatiquement, environ chaque heure (Pro).',
    autoSyncFailed: "Le réglage n'a pas pu être enregistré",
