...
const pl: MessageSchema = {
  ...
  pnl: {
    ...
    coverage: 'Obejmuje {covered} z {total} aktywów z historią transakcji. {value} nie uwzględniono.',
    error: 'Nie udało się załadować zysku/straty.',
  },
  paywall: {
    ...
    unavailable: 'Ulepszenia są teraz niedostępne. Spróbuj ponownie później.',
    planFree: 'Free',
    planPro: 'Pro',
    context: {
      tax: 'Wygeneruj raport podatkowy dla Niemiec i Austrii — z Pro.',
      pnl: 'Zobacz swój bieżący zysk/stratę — z Pro.',
      autoSync: 'Automatycznie aktualizuj swoje salda — z Pro.',
      history1y: 'Zobacz pełny rok historii wartości — z Pro.',
      unlimitedPortfolios: 'Dodaj więcej portfeli — bez limitu z Pro.',
      unlimitedSources: 'Połącz więcej źródeł — bez limitu z Pro.',
    },
    feature: {
  ...
  referral: {
    ...
    title: 'Zapraszaj i zdobywaj Pro',
    rewardHeadline: 'Zaproś znajomych – oboje otrzymacie {days} dni Pro za darmo',
    rewardSub: 'Twój znajomy dostaje {days} dni Pro przy rejestracji; ty dostajesz {days} dni, gdy przejdzie na Pro.',
    linkLabel: 'Twój link polecający',
    share: 'Udostępnij link',
    shareText: 'Śledź swój portfel kryptowalut w tej aplikacji – użyj mojego kodu, aby otrzymać Pro za darmo:',
    copied: 'Link skopiowany',
    earnedProDays: 'Zdobyte dni Pro',
    proConversions: 'Konwersje Pro',
  ...
  sources: {
    ...
    countLimit: 'Wykorzystano {used} z {limit} darmowych źródeł',
  ...
  settings: {
    ...
    autoSyncHelper: 'Automatycznie aktualizuje salda, mniej więcej co godzinę (Pro).',
    autoSyncFailed: 'Nie udało się zapisać ustawienia',
