...
const cs: MessageSchema = {
  ...
  referral: {
    ...
    title: 'Pozvi a vydělávej',
    linkLabel: 'Tvůj doporučující odkaz',
    share: 'Sdílet odkaz',
    shareText: 'Sleduj své krypto portfolio v této aplikaci:',
    copied: 'Odkaz zkopírován',
    earningsOwed: 'Nevyplacené výdělky',
    earningsPaid: 'Vyplaceno',
    invited: 'Pozvané účty',
    invitedEmpty: 'Zatím žádné pozvánky.',
    bankTitle: 'Bankovní účet pro výplatu',
    bankSaved: 'Uložený účet',
    holder: 'Majitel účtu',
    iban: 'IBAN',
    bic: 'BIC',
    save: 'Uložit',
