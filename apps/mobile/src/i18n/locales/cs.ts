...
const cs: MessageSchema = {
  ...
  dashboard: {
    ...
    range30d: '30d',
    range1y: '1R',
    historyExcluded: '{n} aktiv nezahrnuto — historie zobrazuje největší pozice.',
    ...
    historyEmpty: 'Pro vaše aktiva zatím není historie k dispozici.',
  ...
  pnl: {
    ...
    coverage: 'Zahrnuje {covered} z {total} aktiv s historií transakcí. {value} není zahrnuto.',
    error: 'Zisk/ztrátu se nepodařilo načíst.',
  },
  paywall: {
    ...
    unavailable: 'Upgrade nyní není dostupný. Zkuste to prosím později.',
    planFree: 'Free',
    planPro: 'Pro',
    context: {
      tax: 'Vytvořte daňový report pro Německo a Rakousko — s Pro.',
      pnl: 'Sledujte svůj průběžný zisk/ztrátu — s Pro.',
      autoSync: 'Udržujte své zůstatky automaticky aktuální — s Pro.',
      history1y: 'Prohlédněte si celý rok historie hodnoty — s Pro.',
      unlimitedPortfolios: 'Přidejte více portfolií — neomezeně s Pro.',
      unlimitedSources: 'Připojte více zdrojů — neomezeně s Pro.',
    },
    feature: {
  ...
  referral: {
    settingsEntry: 'Doporučující program',
    title: 'Pozvi a získej Pro',
    rewardHeadline: 'Pozvi přátele – oba získáte {days} dní Pro zdarma',
    rewardSub: 'Tvůj přítel získá {days} dní Pro při registraci; ty získáš {days} dní, jakmile přejde na Pro.',
    linkLabel: 'Tvůj doporučující odkaz',
    share: 'Sdílet odkaz',
    shareText: 'Sleduj své krypto portfolio v této aplikaci – s mým kódem získáš Pro zdarma:',
    copied: 'Odkaz zkopírován',
    earnedProDays: 'Získané dny Pro',
    proConversions: 'Konverze na Pro',
    invited: 'Pozvané účty',
    invitedEmpty: 'Zatím žádné pozvánky.',
  },
  update: {
  ...
  sources: {
    ...
    countLimit: 'Využito {used} z {limit} bezplatných zdrojů',
  ...
  settings: {
    ...
    autoSyncHelper: 'Udržuje vaše zůstatky automaticky aktuální, přibližně každou hodinu (Pro).',
    autoSyncFailed: 'Nastavení se nepodařilo uložit',
