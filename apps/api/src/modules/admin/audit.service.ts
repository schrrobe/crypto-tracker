...
export const AuditAction = {
  ...
  PAYOUT_MARKED_SETTLED: 'PAYOUT_MARKED_SETTLED',
  ...
  // Reads/exports of identifiable free-text answers are auditable so admin access to
  // user opinions is not invisible.
  SURVEY_FREETEXT_EXPORTED: 'SURVEY_FREETEXT_EXPORTED',
  SURVEY_REMINDER_SENT: 'SURVEY_REMINDER_SENT',
  ANNOUNCEMENT_CREATED: 'ANNOUNCEMENT_CREATED',
  ANNOUNCEMENT_UPDATED: 'ANNOUNCEMENT_UPDATED',
  ANNOUNCEMENT_DELETED: 'ANNOUNCEMENT_DELETED',
  ASSET_MAPPING_UPDATED: 'ASSET_MAPPING_UPDATED',
  ASSET_MAPPING_CLEARED: 'ASSET_MAPPING_CLEARED',
} as const
