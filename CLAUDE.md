...
**Language convention:** **commit messages use English Conventional Commits** (`feat:`, `fix:`, `docs:`, `chore:`, `refactor:`, `test:`); **README files and code comments are English**. `docs/` files and server error texts remain German. The frontend localizes via stable `error.code` values (6 locales: DE/EN/FR/PL/CS/RU in `apps/mobile/src/i18n/locales/`).
